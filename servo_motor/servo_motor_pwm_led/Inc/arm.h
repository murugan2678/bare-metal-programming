...
volatile struct gpio *GPIOA = (volatile struct gpio *)0x40020000;
volatile struct gpio *GPIOB = (volatile struct gpio *)0x40020400;  // PORTB  GPIOB Register Base address 0x4002 0400
/* here type casting for struct name */
